# important point #1: asyncmode=threading? maybe it's best to omit import eventlet if you don't use it
import time
import queue
import threading
...
# important point #2: going with async_mode=threading? Use stdlib Queue.
